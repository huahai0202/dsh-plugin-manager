...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function activeLocale() {
      ...
      if (snapshot && typeof snapshot.active === "string" && snapshot.active !== "") return snapshot.active;
      return (typeof navigator !== "undefined" && navigator.language ? navigator.language : "en").toLowerCase();
    }
    ...
    function apply(ctx) {
      ...
      ctx.slots.inject("settings.section", function () {
        return ctx.slots.register(
          { name: "settings.section", id: "plugin-manager", order: 16, label: function () { return dict().nav; }, locale: locale !== undefined ? LOCALE_NS : undefined },
